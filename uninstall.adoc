...
+
For more information about detaching clusters, see the _Removing a cluster from management_ section by selecting the information for your provider in xref:./clusters/create.adoc#creating-a-cluster[Creating a cluster]. 
...
----
+
For more information about removing the bare metal assets, see xref:./clusters/bare_assets.adoc#removing-a-bare-metal-asset[Removing a bare metal asset].
