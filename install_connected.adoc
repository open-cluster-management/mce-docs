...
If you are reinstalling {product-title-short} and the pods do not start, see link:./uninstall.adoc#troubleshoot-uninstall[Troubleshooting reinstallation failure] for steps to work around this problem.
