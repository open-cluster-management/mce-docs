...
. On your engine cluster, annotate the `klusterletaddonconfig` to pause replication. See the following command:
...
. On your engine cluster, scale down the `klusterlet-addon-operator`. See the following command:
